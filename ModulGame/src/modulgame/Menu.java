...
public class Menu extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nama : Abighail Shafira Ihsani");
        jLabel2.setToolTipText("");

        jLabel3.setText("NIM : 1908860");

        jLabel5.setText("Level");

        jLabel6.setText("Mode");

        cbMode.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2" }));
        ...
        cbLevel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Easy", "Normal", "Hard" }));
    ...
    private void Btn_PlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Btn_PlayActionPerformed
        ...
        String selectedMode = cbMode.getSelectedItem().toString();
        if(!TF_Username.getText().equals("")){
            new Game(TF_Username.getText(), selectedLevel, selectedMode);
            this.dispose();
        }else{
